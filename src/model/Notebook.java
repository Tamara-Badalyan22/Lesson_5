...
public class Notebook extends Technology {
    ...
    public Notebook(String model, String country, double price,int year) {
        super(model, country, price, year);
    }

    public Notebook(String model, String country, double price,int year, int ram, int processorSpeed, String processorName, String operatingSystem) {
        super(model, country, price, year);
        setRam(ram);
